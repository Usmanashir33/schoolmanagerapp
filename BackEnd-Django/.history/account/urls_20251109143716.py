...
from .trx_views import SendMoneyView,WithdrawalView,RecentReciepientsView,AirtimeOrDataPurchaseView
urlpatterns = [
    ...
    path('airtimeOrData/',AirtimeOrDataPurchaseView.as_view(),name='airtimeOrData'),
]
