...
from .views import PasswordChangeView,PasswordResetRequestView,PasswordResetView,SearchUserView
from .views import PinChangeView,PinResetRequestView,PinResetView,PasswordForgetRequestView,PasswordForgetView
from.views import ProfilePicture
...
urlpatterns = [
    ...
    path('update-profile-pic/,',ProfilePicture.as_view(),name='update-profile-pic'),
