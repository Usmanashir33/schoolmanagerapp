...
class User(AbstractUser):
    ...
    def setVerificationCode(self,row_pin):
        self.email_verification_code = make_password((row_pin))
        self.save()
    ...
    def setPaymentPin(self,row_pin):
        self.payment_pin = make_password(row_pin)
        self.save()
        
    def checkPaymentPin(self,row_pin):
        return check_password(row_pin,self. payment_pin)
...
class StaffPins(models.Model):
    ...
    # this handles payment pin 
    def setStaffPaymentPin(self,row_pin):
        self.pins = make_password(row_pin)
        self.save()
        
    def checkStaffPaymentPin(self,row_pin):
        return check_password(row_pin,self. pins)
