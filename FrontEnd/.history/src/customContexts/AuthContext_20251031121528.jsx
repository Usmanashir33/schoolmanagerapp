    ...
    const  getCurrentUser = async () => {
        ...
        fetch(`${config.BASE_URL}/authuser/current-user/`,{
            ...
            headers : {
                ...
                Authorization : `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzYxOTA5Mjk2LCJpYXQiOjE3NjE5MDg2MDgsImp0aSI6ImE3ZGUxYWI2M2JkNTQyMTViYTRkOWQ3MTcxZTAxNWM2IiwidXNlcl9pZCI6ImU4NzY5YWEwLTU4ZmYtNDAxMC04MjM1LWNlMGM2MTJjZTIwOCJ9.HcBRtcHC-5RTYa0psvgwAkgTZ2exOPzP7Ka_ovywPkM`
            }
        }).then ((resp) => {
            if (resp.ok){
                return resp.json();
