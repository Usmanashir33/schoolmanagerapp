  ...
  return (
    ...
    className="flex   justify-center items-cente  bg-gray-50 absolute w-full top-0 min-h-full z-30 ">
      ...
      <div className="w-full bg-white rounded-lg shadow-md px-5 relative py-2  ">
        <span 
        onClick={() => {close(false)}}
        className="text-blue-600 flex gap-1 items-center  mx-auto cursor-pointer !rounded-button whitespace-nowrap text-sm">
            <ArrowLeft strokeWidth={1.2} className="w-5 h-5"/>
            Back
        </span>
        {
          <>
