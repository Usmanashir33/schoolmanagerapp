          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex gap-3 mt-4">
                ...
                className="bg-gray-900 bg-opacity-90 hover:bg-opacity-50 transition-all duration-300 py-2 px-4 rounded-lg flex-1 text-sm font-medium flex items-center justify-center cursor-pointer hover:transform hover:scale-105 !rounded-button whitespace-nowrap">
