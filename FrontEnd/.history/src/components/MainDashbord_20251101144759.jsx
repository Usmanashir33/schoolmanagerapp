              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="relative">
                  <button className="flex items-center text-gray-700 focus:outline-none cursor-pointer !rounded-button whitespace-nowrap">
                    ...
                    strokeWidth={3} className=' ml-2 w-4 text-gray-600 cursor-pointer h-4 text-gray-600 cursor-pointer hover:bg-gray-100 rounded-lg'/>
                  </button>

                  {/* dropdown here  */}
                  {showAccounts && 
                  <div className="absolute top-7 w-fullright-0  mt-2  bg-white border border-gray-200 rounded-md shadow-lg">
                    <ul className="">
                      <li>
