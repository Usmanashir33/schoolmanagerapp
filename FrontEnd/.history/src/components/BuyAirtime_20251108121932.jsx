    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 flex flex-col items-center">
      <div className="bg-white shadow-2xl rounded-2xl w-full max-w-3xl p-6 animate-fadeIn relative">
        ...
        <div className="mb-4 flex items-center border rounded-xl px-3 py-2 bg-gray-50 focus-within:border-blue-400">
          ...
          <input type="number" placeholder="Enter recipient phone number" value={phoneNumber} onChange={(e) => setNumber(e)} className="w-full bg-transparent outline-none text-gray-700 placeholder-gray-400" />
        </div>
        ...
        <div className="mb-4  ">
          ...
          <input type="number" placeholder="Custom amount" value={amount} onChange={(e) => setAmount(e.target.value)} className="w-full px-4 py-2 border  rounded-xl bg-gray-50 outline-none focus:border-blue-400" />
        </div>
