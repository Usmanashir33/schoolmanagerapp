...
const TrxCard = ({trx}) => {
    ...
    const WithdrawalTrx = () => {
      return (
        <div className=" bbd flex items-center justify-between p-2 bg-gray-50 rounded-lg cursor-pointer transform transition-all duration-300 hover:bg-white hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]">
                  <div className="flex items-center space-x-4">
                    <div className="h-12 w-12 rounded-full bg-red-100 flex items-center justify-center">
                      <i className="fas fa-arrow-up text-red-500 text-lg"></i>
                    </div>
    ...
    return ( 
      <>
      {/* transections  */}
              <div className="p-2 grid grid-cols-1 " onClick={() => {navigate(`/trx-status/${trx.id}`)}}>
