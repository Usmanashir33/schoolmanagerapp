...
import { AlertCircle, AlertTriangle, CopyIcon, Edit3, SidebarClose } from "lucide-react";
          ...
          <div className="absolute top-0 p-4">
            ...
            <div className="ml-4">
              ...
              {currentUser?.kyc_confirmed? 
               ...
               : 
              (currentUser?.kyc_submitted?.              (currentUser?.kyc_submitted?.toUpperCase() === "PENDING" || currentUser?.kyc_submitted?.toUpperCase() ==="pending" ?
 === "PENDING"?
                <span className="flex items-center text-red-300">
                  <AlertCircle className="w-4 h-4 text-yellow-500 mr-1" />
                  <span className="text-sm">Unverified {currentUser?.kyc_submitted}</span>
                </span>
                :
                <span className="flex items-center text-red-300">
                  <AlertCircle className="w-4 h-4 text-yellow-500 mr-1" />
