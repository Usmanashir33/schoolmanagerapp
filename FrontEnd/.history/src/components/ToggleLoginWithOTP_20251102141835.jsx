  ...
  return (
    <div className="absolute">
      ...
      <button
        ...
        className="px-4 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-all shadow-md"
      >
        Manage Login with OTP
      </button>

      {/* Popup Modal */}
      {showPopup && (
        <div className="fixed inset-0 flex items-center justify-center bg-black-400 backdrop-blur-sm z-10">
