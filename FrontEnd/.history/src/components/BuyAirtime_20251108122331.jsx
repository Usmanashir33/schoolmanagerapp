        ...
        <div className="mb-4  ">
          ...
          <span className="flex">
             <input type="tel" placeholder="Custom amount (<₦ 10,000)" value={amount} onChange={(e) => setAmountTyped(e.target.value)} className="w-full px-4 py-2 border  rounded-xl bg-gray-50 outline-none focus:border-blue-400" />
                <button onClick={() => handleBuy(amount)} className="ml-3 px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition !rounded-button whitespace-nowrap">Buy Airtime
          </span>
        </div>
