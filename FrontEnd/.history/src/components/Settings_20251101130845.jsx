      ...
      <div className="w-full bg-white shadow-sm transition-all duration-300 hover:shadow-md">
        <div className="p-4 ">
          ...
          <div className="mt-8 mb-4"> 
            <button className="w-full py-3 bg-red-500 text-white rounded-lg hover:bg-opacity-80000 transition-all duration-300 hover:shadow-md transform hover:-translate-y-1font-medium rounded-lg !rounded-button whitespace-nowrap cursor-pointer hover:bg-red-100 transition-all duration-300 hover:shadow-md transform hover:-translate-y-1"
            onClick={() => {setConfirmLogout(true)}}>
