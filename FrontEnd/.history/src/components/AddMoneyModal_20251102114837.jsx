...
const AddMoneyModal = ({toggleModal}) => {
    ...
    const accountNumbersRef = useRef(null);
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
          if (accountNumbersRef.current && !accountNumbersRef.current.contains(event.target)) {
...
>
              ...
              {showAccounts && <div ref={accountNumbersRef} className="absolute w-full bottom-100 z-10 rounded-md bg-gray-100 shadow-sm shadow-lg border-1  border-gray-200">
