    ...
    return (  
        ...
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
            ...
            <Link to="/ho" className={`${checkActive("/home")} flex items-center px-3 py-2 text-gray-600 rounded-lg transition-all duration-300 hover:border-blue-500 hover:shadow-md group` }>
