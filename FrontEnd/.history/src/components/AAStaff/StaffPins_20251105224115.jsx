      ...
      {(
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-30">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-4 relative">
            ...
            {/* pop of form to collect otp from users Email  */}
            <div className=" absolute  shadow-xl w-full max-w-sm  z-10 bg-white flex  flex-col items-center mb-4"> 
              <h2 className="text-lg font-semibold text-gray-800">
                Provide the PIN sent to your registered email address
              </h2>
              <input type="text" name="Otp" id=""  className="w-full bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded" placeholder="Enter Password here"/>
            </div>
