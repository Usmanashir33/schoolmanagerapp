...
const Analysis = () => {
  ...
  return (
    <div className=" bg-gray-50 p-4 md:p-3 w-full max-w-[1440px] mx-auto overflow-auto hide-scrollbar">
        {/* Performance Chart */}
      
      
      {/* Header Stats */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-3 mb-8">
        <div className="bg-white rounded-lg p-3 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">
              Transaction Analysis
            </h3>
            <div className="flex gap-2 sticky top-0 bg-white p-2 rounded-md shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-3 mb-8  ">
        <div className="bg-white rounded-lg p-3 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-green-500 text-sm font-medium">
              {summary?.total_balance?.change || "+0.00%"}
            </span>
          </div>
          <p className="text-gray-600 text-sm">Total Balance</p>
          <p className="text-2xl font-bold text-gray-900">{
            formatNaira(summary?.total_balance?.value) || "0.00"
          }</p>
        </div>
        <div className="bg-white rounded-lg p-3 shadow-sm">
          <div className="flex items-center justify-between mb-2">
          ...
          <p className="text-2xl font-bold text-gray-900">leter</p>
        </div>
        <div className="bg-white rounded-lg p-3 shadow-sm">
          <div className="flex items-center justify-between mb-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <p className="text-xl font-bold text-gray-900" id="outflow-value">
                {formatNaira(analysis?.outflow?.value) || "0.00"}
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                >
                  {analysis?.total_transactions?.change || "+0.00%"}
                </span>
              </div>
              ...
              >
                {analysis?.total_transactions?.value || "0"}
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
      ...
      {/* Main Content Grid */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-3 mb-8">
