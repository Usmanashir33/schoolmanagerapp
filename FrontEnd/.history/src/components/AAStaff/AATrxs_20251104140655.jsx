                ...
                <div className="flex space-x-3 relative ">
                  <div className="relative">
                    <button className="flex items-center space-x-2 px-2 py-2 border border-gray-300 rounded-lg text-gray-600 hover:bg-gray-50 cursor-pointer !rounded-button whitespace-nowrap">
                      ...
                      <span onClick={() => setIsFilterOpen(true)}  className="text-xs">{transactionType? transactionType :'All Types'}</span>
                  ...
                  {/* show filterd date  */} 
                      ...
                      <div className=" absolute -bottom-3 left-10 flex justify-between items-center text-xs font-medium text-blue">
