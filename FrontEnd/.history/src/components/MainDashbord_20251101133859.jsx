            ...
            <div className="flex items-center justify-between h-16 px-6">
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="relative">
                  ...
                  <div className="absolute right-0 mt-2 w-max height-md bdd bg-white border border-gray-200 rounded-md shadow-lg">
                    
                    {/* Dropdown menu could go here */}
                    <div className="mt-2 w-48 height-md  bg-white border border-gray-200 rounded-md shadow-lg">
                    <p>hhh</p>
                    <p>hhh</p>
                    <p>hhh</p>
                    <p>hhh</p>
