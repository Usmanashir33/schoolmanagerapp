...
import { AlertCircle, AlertTriangle, CopyIcon, Edit3, Loader, SidebarClose } from "lucide-react";
        ...
        <div className="relative bg-gradient-to-r from-purple-600 to-indigo-600  text-white shadow-lg transform transition-all duration-300 ease-in-out rounded-b-xl">
          ...
          <div className="absolute top-0 p-4">
            ...
            <div className="ml-4">
              ...
              {!currentUser?.kyc_confirmed? 
                <span className="flex items-center text-green-300">
                  <i className="fas fa-check-circle mr-1"></i>
                  <span className="text-sm">Verified</span>
                </span>
               : 
              // (currentUser?.kyc_submitted?.toUpperCase() === "PENDING"?
              (currentUser?.kyc_submitted?.toUpperCase() === "VERIIFED"?
                <span className="flex items-center text-yellow-500 aninmate-pulse ">
                  <Loader className="w-4 h-4 text-yellow-500 mr-1" />
