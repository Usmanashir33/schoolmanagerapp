        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4  border-b relative ">
            ...
            <div className="mt-4 flex justify-between text-sm text-gray-600 ">
              ...
              {showBalance
                ?<EyeClosed strokeWidth={1.2} className="w-5 cursor-pointer" onClick={setShowBalance(!)} />
                : 
                <EyeIcon strokeWidth={1.2}  className="w-5 cursor-pointer"onClick={setShowBalance(!)}/>
              }
              <div>
