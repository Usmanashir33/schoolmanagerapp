    ...
    const  getCurrentUser = async () => {
        ...
        fetch(`${config.BASE_URL}/authuser/current-user/`,{
            ...
            headers : {
                ...
                Authorization : `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzY0NTAzNDEzLCJpYXQiOjE3NjE5MTE0MTMsImp0aSI6ImY2MGUzMGQ4MzE2MjQ0MjM5NTEzNzYzZjkzN2M1NTYxIiwidXNlcl9pZCI6ImU4NzY5YWEwLTU4ZmYtNDAxMC04MjM1LWNlMGM2MTJjZTIwOCJ9.4XjF6wYKjN5ofWc-aLTrIGhOp7cTIVnpeXi09I8yCOU`
            }
        }).then ((resp) => {
            if (resp.ok){
                return resp.json();
