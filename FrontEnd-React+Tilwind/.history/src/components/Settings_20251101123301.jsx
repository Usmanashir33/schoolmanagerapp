...
const Settings = () => {
  ...
  const LogoutPanel = () => {
    return(
      <>
        { <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 w-md ">
          <div className="bg-white rounded-xl p-4 w-[90%] max-w-md">
            <div className="flex justify-between items-center mb-6 gap-10 bbd ">
