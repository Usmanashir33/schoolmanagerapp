      ...
      <div className="min-h-screen bg-gray-50 font-san ">
        ...
        <div className="px-4 py-0 ">
          ...
          <div className="grid grid-cols-3 gap-3 mb-6">
            <Link to={`/data`} className="bg-white rounded-xl p-4 flex flex-col items-center shadow-sm cursor-pointer hover:shadow-md transition-shadow">
              <div
            ...
            <Link to={`/airtime`} className="bg-white rounded-xl p-4 flex flex-col items-center shadow-sm cursor-pointer hover:shadow-md transition-shadow">
