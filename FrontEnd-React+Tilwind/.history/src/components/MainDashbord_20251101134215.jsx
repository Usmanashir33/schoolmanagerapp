...
import { BanknoteArrowUp, Bell,  ChevronDownIcon,  ChevronLast,  MessageSquare } from 'lucide-react';
                ...
                <div className="relative">
                  <button className="flex items-center text-gray-700 focus:outline-none cursor-pointer !rounded-button whitespace-nowrap">
                    ...
                    <div className="w-8 h-8 overflow-hidden rounded-full bg-gray-200">
                      ...
                      />
                    </div>{currentUser?.is_staff && <Link to={`/staffusers`}className="flex items-center px-3 py-2 text-gray-600 rounded-lg hover:bg-gray-50 border ">
              <StarIco strokeWidth={1} className="mr-2 w-3  text-green-900"/>
              <span className="font-semibold text-sm text-green-900">Staff</span>
            </Link>}
                    <ChevronDownIcon  strokeWidth={2} className=' ml-2 w-4 h-4 hover:bg-gray-100 rounded-lg'/>
                  </button>
                  <div className="absolute right-0  min-w-max mt-2 w-max height-md bg-white border border-gray-200 rounded-md shadow-lg">
                    <ul>
                      <li>
