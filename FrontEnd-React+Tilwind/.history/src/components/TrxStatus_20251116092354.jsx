...
const TrxStatus= ({close, trxDetails}) => { 
  ...
  return (
    <div 
    className=" absolute flex rounded-md justify-center items-center  bg-gray-50 absolute w-full top-0 min-h-ful z-30">
      <div className="w-full bg-white rounded-lg shadow-md px-4 relative py-2">
        <span 
        onClick={() => {close(false)}}
        className=" sticky rounded-md  top-0 text-blue-600  items-center  text-sm flex bg-white gap-2 items-center mx-auto cursor-pointer !rounded-button whitespace-nowrap pb-1">
