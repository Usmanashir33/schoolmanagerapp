          ...
          <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl shadow-2xl p-6 w-[90%] max-w-sm relative animate-fadeIn">
              ...
              <div className="flex justify-center gap-4 mt-5">
                ...
                <button onClick={() => { 
                    alert(`Purchased ${confirmation.size} on ${confirmation.number} (${confirmation.network}) for ₦${confirmation.price
                        
                    }`); setConfirmation(null); }} className="px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700">Confirm</button>
              </div>
            </div>
          </div>
        )}
