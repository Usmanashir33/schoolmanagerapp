...
const TrxCard = ({trx}) => {
    ...
    const DataPurchase = () => {
        return (
            <div className="flex items-center justify-between p-2 bbd bg-gray-50 rounded-lg cursor-pointer transform transition-all duration-300 hover:bg-white hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]">
                  <div className="flex items-center space-x-4">
