...
import { BookDashed, Cog, CogIcon, EyeClosed, Headset, Home, HomeIcon, LayoutDashboard, Lock, LogOut, LucideHome, LucideStarOff, Repeat1, RepeatIcon, ReplaceAll, ShieldAlert, StarIcon, SwatchBookIcon, User, User2Icon, Users, Users2, WalletCards } from "lucide-react";
          ...
          <div className="p-4  border-b relative ">
            <div  className="flex items-center space-x-2  justify-between">
              <div className="flex items-cente space-x-4">
                <div className="w-15 h-15 rounded-full overflow-hidden  rounded-full overflow-hidden  ">
