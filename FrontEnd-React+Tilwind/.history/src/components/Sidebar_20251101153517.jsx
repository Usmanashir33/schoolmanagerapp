            ...
            <div className="mt-4 flex justify-between text-sm text-gray-600 ">
              <div>
                ...
                <span className="flex gap-4">
                  ...
                  : "*******"}
                  {showBalance
                    ?<EyeClosed strokeWidth={1.2} className="w-5 cursor-pointer  " onClick={() => setShowBalance(!showBalance)} />
                    : 
                    <EyeIcon strokeWidth={1.2}  className="w-5 cursor-pointer " onClick={() => setShowBalance(!showBalance)}/>
                    }
                </span>
              </div>
