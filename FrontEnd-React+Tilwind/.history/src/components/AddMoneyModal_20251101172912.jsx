        ...
        <div className="bg-white rounded-xl p-6 w-[90%] max-w-md">
          ...
          <div className="space-y-4  ">
             <div className="relative bg-gray-50 rounded-xl p-2 flex items-center cursor-pointer hover:bg-gray-100 transition-colors relative ">
              ...
              <div className="">
                <h4 className="font-medium">Bank              <ChevronRight className=" ml-auto text-gray-400 hover:text-black"
              ...
              <div className="absolute  bottom-0 rounded-xl border-2 border-dashed border-gray-300 pointer-events-none">
