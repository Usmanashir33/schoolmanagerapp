    ...
    <div className="min-h-max bg-gray-50  ">
      ...
      <button className="z-20 absolute top-2 right-3 flex  gap-2 items-center cursor-pointer !rounded-button whitespace-nowrap">
            <div className=" rounded-full cursor-pointer flex gap-2   items-center justify-center ">
              <i className="fas fa-question-circle text-xl text-blue-500 hover:text-blue-900 hover:text-red-600"></i>
            </div>
        ...
        >
          ...
          <div className="text-sm font-bold   rounded-full -mb-3">
            {transaction_type}
          </div>
        </div>
        ...
        <div className="px-3 border-b border-gray-100">
            <div className="flex justify-between gap-4 my-2 grid grid-cols-2 ">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <p className="text-sm font-medium text-gray-800 flex items-center gap-2">
                      <img src={getNetworkLogo(network)} alt={network} className=" rounded-sm w-4 h-4" />
                      <span> {network || "REF-No"} </span>
                    </p>
                    {trx_ref && <button 
                    onClick={() => 
                      {copyToClipboard(trx_ref,'transectin Ref No copied!')}
