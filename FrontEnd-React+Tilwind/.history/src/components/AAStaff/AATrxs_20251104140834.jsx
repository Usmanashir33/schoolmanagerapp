            ...
            <div className="p-4">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex space-x-3 relative ">
                  ...
                  <button onClick={() => setIsFilterOpen(true)} ="flex items-center space-x-2 px-2 py-2 border border-gray-300 rounded-lg text-gray-600 hover:bg-gray-50 cursor-pointer !rounded-button whitespace-nowrap">
