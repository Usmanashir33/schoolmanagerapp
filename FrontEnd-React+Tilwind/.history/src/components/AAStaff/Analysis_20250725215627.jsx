...
const Analysis = () => {
  ...
  return (
    <div className=" bg-gray-50 p-4 md:p-6 w-full max-w-[1440px] mx-auto overflow-auto hide-scrollbar">
        {/* Performance Chart */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 bbd ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 b">
        <div className="bg-white rounded-lg p-6 shadow-sm">
