...
import { Backpack, BanknoteArrowUp, Gauge, LineChart, Lock, LucideBanknoteArrowDown, Settings,  User, Users, X } from 'lucide-react';
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <div className="flex-1 flex-col flex justify-between">
          ...
          <Link to={`/dashbord`}className="mb-2 flex items-center px-3 py-2  rounded-lg hover:bg-blue-700 border ">
