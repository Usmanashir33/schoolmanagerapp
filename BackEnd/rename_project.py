...
def main():
    if len(sys.argv) < 3:
        print("Usage: python rename_SchoolManagerProject.py old_name new_name")
        sys.exit(1)

    old_name = sys.argv[1]
    # 🔥 force lowercase SchoolManagerProject name
    new_name = sys.argv[2]

    print(f"\n🔄 Renaming Django SchoolManagerProject: {old_name} → {new_name}\n")
    ...
    print("\n🎉 DONE! Django SchoolManagerProject renamed successfully.\n")
