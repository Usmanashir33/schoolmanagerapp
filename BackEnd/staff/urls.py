...
urlpatterns = [
    ...
    path('details/<uuid:school_id>/<str:staff_id>/',   StaffCreateUpdateView.as_view(), name='get-staff'), #Tested
    ...
    path('search/staff/<uuid:school_id>/<str:searchQuery>/',FilterStaffView.as_view(),  name='search-staff'),#Tested
