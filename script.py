...
sys.path.append(r"C:\Users\Welcome Sir\Desktop\fentech backproject\fentech back")
...
for user in users:
    # check if there is Attribute staffpins
    if hasattr(user,'staffpins'):
        ...
        print(f"No staffpins attribute for user: {user.email}")
# for user in users:
#     if user.payment_pin:
